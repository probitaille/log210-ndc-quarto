...
- **Un nom** : peut être un nom d'instance (`monInstance`), un nom de classe (`:MaClasse`), ou les deux (`monInstance:MaClasse`)
...
- `nomObjet:NomClasse` identifie une instance spécifique
